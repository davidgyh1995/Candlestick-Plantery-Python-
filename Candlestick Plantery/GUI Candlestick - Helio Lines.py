...
Stardict = {
    "Mercury" : [1,0,'gray',[],"button0"],
    "Venus" : [2,0,'yellow',[],"button1"],
    "Mars" : [3,0,'brown',[],"button2"],
    "Jupiter" : [4,0,'orange',[],"button3"],
    "Saturn" : [5,0,'gold',[],"button4"],
    "Uranus" : [6,0,'blue',[],"button5"],
    "U-S" : [7,0,'Green',[],"button6"],
    "U-J" : [8,0,'Green',[],"button7"],
    "U-M" : [9,0,'Green',[],"button8"],
    "U - V" :[10,0,'Green',[],"button9"], 
    "U - Me" : [11,0,'Green',[],"button10"],
    "S-J" : [12,0,'red',[],"button11"],
    "S -M" : [13,0,'Green',[],"button12"],
    "S - V" : [14,0,'Green',[],"button13"],
    "S - Me" : [15,0,'Green',[],"button14"],
    "J - M" : [16,0,'orange',[],"button15"],
    "J - V" : [17,0,'Green',[],"button15"],
    "J - Me" : [18,0,'Green',[],"button15"],
    "M - V" : [19,0,'Green',[],"button15"],
    "M - Me" : [20,0,'Green',[],"button15"],
    "V - Me" : [21,0,'Green',[],"button15"]
    }
#Angle = 30
#Lines = int(360/Angle)
dateshowing = 500
...
#a = pd.read_csv('C:/Users/david/OneDrive/Desktop/Candlestick Plantery/000001.SS.csv')
a['Date'] = pd.to_datetime(a["Date"], format="%m/%d/%Y")
StartDate = '20010824'
StartDatetime = datetime.strptime(StartDate, '%Y%m%d')
latestdate = (a['Date'][1:0])
...
mpf.candlestick_ohlc(ax1,zip(mdates.date2num(a['Date']),a['Open'], a['High'],
                                a['Low'], a['Close']),
...
def ShowLine(E1,E2,E3,Combo1,E5,E6,self):
    ...
    for i in range(Lines):
        try:
            ...
            print('--------------------------')
            print('        DateTime:',b['Time'][Cycle_Chaning_index])
            print('Index/Star/Angle:',i," / ",Star," / ", b[Star][Cycle_Chaning_index])
...
##########
        ...
        self.button8 = tk.Button(self, text="U-M",
                            command=lambda: showStar('U-M',self))
